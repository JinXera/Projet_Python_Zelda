...
class Player(Entity):
    ...
    def input(self):
        if not self.attacking:
            ...
            # attack input
            if keys[pygame.K_SPACE]: # à changer avec le clic gauche de la souris
                self.attacking = True
            ...
            if keys[pygame.K_LSHIFT] and self.can_switch_weapon:
                ...
                self.weapons_switch_time = pygame.time.get_ticks()
    ...
    def cooldowns(self):
        ...
        if not self.can_switch_weapon:
            if current_time - self.weapons_switch_time >= self.switch_duration_cooldown:
                self.can_switch_weapon = True
